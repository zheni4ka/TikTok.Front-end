...
const Header: React.FC = () => {
    ...
    return (
        <>
            <HeaderAntd style={{ display: 'grid', width: '100%', gridTemplateColumns: '1fr 1fr 1fr', gridTemplateRows: '50px', background: 'black' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 'auto' }}>
                    ...
                    <Modal open={isModalOpen} onCancel={handleCancel} className="custom-modal" bodyStyle={{ backgroundColor: '#252525' }} style={{ backgroundColor: '#252525' }} footer={null}>
                        <div className="modal-content">
                            ...
                            <h3>Or</h3>
                            <Button className="button-guest" type="default" onClick={handleCancel}>
